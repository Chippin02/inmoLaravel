...
<head>
    ...
    <title>{{ config('app.name', 'InmoLaravel') }}</title>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            <li class="nav-item dropdown" style="display: flex;">
                                ...
                                <a class="nav-link" href="{{ route('publications.index') }}">{{ __('Publicaciones') }}</a>
                                <a class="nav-link" href="{{ route('properties.index') }}">{{ __('Propiedades') }}</a>
